...
- [Hypno](https://github.com/STCData/Hypno) - An application to collect analytics of user usage of any application in the system via broadcast extension and machine learning. Integrated with ChatGPT for on the fly data transformation
