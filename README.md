...
* [SwiftyDB](https://github.com/izouxv/swiftydb) - A Swift SQLite 3 ORM library, easy to use. nested-transactions, migration, thread-safety, carthage. Swift 3 support.
