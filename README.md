...
* [FileProvider](https://github.com/amosavian/FileProvider) - FileManager replacement for Local, iCloud and Remote (WebDAV/Dropbox/OneDrive/SMB2) files on iOS/tvOS and macOS. :large_orange_diamond:
...
* [Tabman](https://github.com/msaps/Tabman) - A powerful paging view controller with indicator bar for iOS. 🔶
...
* [KiteKit](https://github.com/kitecomp/kitekit) - KiteKit for iOS and Mac :large_orange_diamond:
